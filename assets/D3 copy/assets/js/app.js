...
(async function(){
    const censusData = await d3.csv("assets/data/state_by_category.csv");
    ...
    // Create group for  7 x- axis labels
    var xLabelsGroup = chartGroup.append("g")
        .attr("transform", `translate(${width / 2}, ${height + 20})`);

    var burgerLabel = xLabelsGroup.append("text")
        .attr("x", 0)
        .attr("y", 20)
    ...
    var ethnicLabel = xLabelsGroup.append("text")
        .attr("x", 0)
        .attr("y", 60)
    ...
    var pizzaLabel = xLabelsGroup.append("text")
        .attr("x", 0)
        .attr("y", 80)
        .attr("value", "age") // value to grab for event listener
        .classed("inactive", true)
    ...
    var sandwichLabel = xLabelsGroup.append("text")
        .attr("x", 0)
        .attr("y", 100)
        .attr("value", "age") // value to grab for event listener
        .classed("inactive", true)
    ...
    var seafoodLabel = xLabelsGroup.append("text")
        .attr("x", 0)
        .attr("y", 120)
        .attr("value", "age") // value to grab for event listener
        .classed("inactive", true)
    ...
    var snackLabel = xLabelsGroup.append("text")
        .attr("x", 0)
        .attr("y", 140)
        .attr("value", "age") // value to grab for event listener
        .classed("inactive", true)
